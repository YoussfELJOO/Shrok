...
GAME_MESSAGE = "ᯓ1𝐐𝐘𝐎𝐔𝐒𝐅_𝐄𝐋𝐐𝐉𝐎𝐎 𓃠\n\n★¦ مرحبا بك عزيزي:\n★¦في قسم العاب _𝐄𝐋𝐐𝐉𝐎𝐎\n\nᯓ1𝐐𝐘𝐎𝐔𝐒𝐅_𝐄𝐋𝐐𝐉𝐎𝐎 𓃠"
GAME_BUTTONS = [
    [ 
        InlineKeyboardButton ('الالعــاب-3D', callback_data= 'GAME1'),
        InlineKeyboardButton ('الالعــاب', callback_data= 'GAME2'),
        ],[
        InlineKeyboardButton ('ᯓ1𝐐𝐘𝐎𝐔𝐒𝐅_𝐄𝐋𝐐𝐉𝐎𝐎 𓃠', url =f"https://t.me/source_rolexs")              
                 ],[
...
async def callback_query(client, CallbackQuery):
          if CallbackQuery.data == "GAME1":
             ...
             GAME1_MESSAGE = "ᯓ1𝐐𝐘𝐎𝐔𝐒𝐅_𝐄𝐋𝐐𝐉𝐎𝐎 𓃠\n\nمرحبا بك في قسم العاب 3D\n\nᯓ1𝐐𝐘𝐎𝐔𝐒𝐅_𝐄𝐋𝐐𝐉𝐎𝐎 𓃠"
