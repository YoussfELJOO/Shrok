...
@app.on_message(filters.command(["1𝐐𝐘𝐎𝐔𝐒𝐅_𝐄𝐋𝐐𝐉𝐎𝐎","مطور السورس","مبرمج السورس","المطور"],"")
)
async def huhh(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/96857cb597b588139fdd5.jpg",
        caption=f"""◉ 𝙽𝙰𝙼𝙴 : ❪[ْ1𝐐𝐘𝐎𝐔𝐒𝐅_𝐄𝐋𝐐𝐉𝐎𝐎](https://t.me/IIUll_l)❫
◉ 𝚄𝚂𝙴𝚁 : ❪ @IIUll_l ❫
◉ 𝙸𝙳      : ❪ `5904216848` ❫
◉ 𝙱𝙸𝙾    : ❪ for me (@UI_VM)  ❫""",
            ...
            [
                [
                    InlineKeyboardButton(
                        "ْ1𝐐𝐘𝐎𝐔𝐒𝐅_𝐄𝐋𝐐𝐉𝐎𝐎", url=f"https://t.me/IIUll_l"), 
                 ],[
                   InlineKeyboardButton(
